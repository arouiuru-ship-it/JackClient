...
public class VisualModule implements ClientModInitializer {
    public static boolean killAura = false, fly = false, esp = false;
    ...
    public void onInitializeClient() {
        HudRenderCallback.EVENT.register((ctx, t) -> {
            ...
            ctx.drawTextWithShadow(mc.textRenderer, Text.literal("Fly " + (fly ? "ON" : "OFF")), 55, 29, 0xFFFFFF);
            ctx.drawTextWithShadow(mc.textRenderer, Text.literal("ESP " + (esp ? "ON" : "OFF")), 110, 29, 0xFFFFFF);
